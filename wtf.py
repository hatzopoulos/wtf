...
actions = slurpy((k,getattr(args,k)) for k in ('trail_space','eof_blanks','eof_newl','match_eol','coerce_eol','expect_eol','tab_space_mix','change_tabs','change_non_leading_tabs','change_spaces'))
